 ...
 * This file demonstrates how to integrate Walletsign with a web frontend
 */

// For React/Vue/Angular applications
export class WalletsignClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new WalletsignClient(provider, contractAddress);
